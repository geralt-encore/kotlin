...
fun MemberDescriptor.isInlineOnlyOrReified(): Boolean =
        this is CallableMemberDescriptor && (isReified() || DescriptorUtils.getDirectMember(this).isReified() || isInlineOnly())
...
private fun CallableMemberDescriptor.isReified() = typeParameters.any { it.isReified }
